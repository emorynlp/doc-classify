...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def step(stepType,x_batch, y_batch, writer=None, lowerbound=57.5):
            ...
            time_str = datetime.datetime.now().isoformat()
            """
            print ("LENGTH IS: ", len(flattedStuff))
            print ("LENGTH IS: ", len(flattedStuff[0]))
            print (flattedStuff[0])
            print ("TYPE IS: ", type(flattedStuff))
            """
            print("{}: {}: step {}, loss {:g}, acc {:g}, neg_r {:g} neg_p {:g} f1_neg {:g}, f1_pos {:g}, f1 {:g}".
        ...
        for batch in batches:
            ...
            if current_step % FLAGS.evaluate_every == 0:
                ...
                step("TEST", x_test, y_test, writer=dev_summary_writer)
                '''
