...
w2vmodel = load_w2v()
 #x_train, y_train = cnn_data_helpers.load_data('trn.csv',w2vmodel , max_len)
 #x_dev, y_dev = cnn_data_helpers.load_data('dev.csv', w2vmodel, max_len)
x_test, y_test  = cnn_data_helpers.load_data('tstTokenized.tsv', w2vmodel, max_len)
del(w2vmodel)
gc.collect()

savepath = './runs/1466718167/checkpoints/model-1300'
