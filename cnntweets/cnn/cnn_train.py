...
tf.flags.DEFINE_integer("test_every", 10, "Evaluate model on test set after this many steps (default: 100)")
...
x_dev, y_dev, _, _ = cnn_data_helpers.load_data('dev', max_len, vocabulary, vocabulary_inv)
